...
function App() {
  const url = 'http://www.hyeumine.com/getcard.php?bcode=iXenW1hm';
  ...
  return (
    <div className="Con">
      ...
      <h4 style={{margin:"0"}}>Game Code: iXenW1hm</h4>
      ...
      <div style={{display:"flex"}}>
        ...
        <button className="btnNavigate" onClick={() => window.location.href = 'http://www.hyeumine.com/bingodashboard.php?bcode=iXenW1hm'}>Go to Bingo Dashboard</button>
      </div>
    </div>
  );
}
